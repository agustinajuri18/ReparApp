...
# Uso de Float para costoServicio, costoRepuesto y subtotal según el esquema de DetalleOrden.

DATABASE_URL = r"sqlite:///C:\Users\pablo\OneDrive\Desktop\Carpeta de Pablo\FACULTAD\SEMINARIO\ReparApp\BDD\ProyectoV3 con cambios.db"
